...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 shadow-sm">
      <div className="container flex h-28 max-w-7xl items-center px-4">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-4 hover:opacity-80 transition-opacity mr-16 flex-shrink-0">
          <img
          ...
          <div className="hidden sm:flex flex-col justify-center">
            <span className="text-lg font-bold text-primary tracking-tight">EBC</span>
            <span className="text-sm text-foreground/70 font-semibold">Executive Briefing Council</span>
          </div>
        </Link>
