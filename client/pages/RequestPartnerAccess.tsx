      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <section className="flex-grow flex items-center justify-center py-20 lg:py-28">
          <div className="container max-w-2xl mx-auto px-4 text-center space-y-6">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-foreground">Partner request received</h1>
            <p className="text-lg text-foreground/70">
              Thank you for your interest in joining the Executive Briefing Council. We've received your access request and will review it shortly.
            </p>
            <p className="text-foreground/60">
              Our team will be in touch within 1-2 business days. In the meantime, if you have any questions, feel free to reach out to <span className="font-medium">partners@itmethods.com</span>.
            </p>
            <Button
              asChild
      ...
      <section className="flex-grow py-20 lg:py-28">
        <div className="container max-w-2xl mx-auto px-4">
          ...
          <div className="mb-12 space-y-3">
            <h1 className="text-3xl lg:text-4xl font-bold text-foreground">Become a technology partner today</h1>
            <p className="text-lg text-foreground/70">
          ...
          {/* Customer CTA */}
          <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-6 space-y-3">
            <p className="font-semibold text-foreground">Looking to request a briefing instead?</p>
            <p className="text-foreground/70">If you're an enterprise leader looking to schedule a briefing, please submit a briefing request.</p>
          ...
          <div className="bg-white border border-border rounded-lg p-8 space-y-6">
            ...
            <div className="p-4 bg-blue-50/50 rounded-lg border border-blue-100">
              <p className="text-sm text-foreground/80 leading-relaxed">
                We carefully review all partner requests to ensure alignment with the Executive Briefing Council's standards. We'll contact you within 1-2 business days to discuss next steps.
              </p>
            </div>
          </div>
        </div>
