...
import { CheckCircle2, Clock, AlertCircle, Plus, Key } from "lucide-react";
...
export default function PortalCustomer() {
  ...
  useEffect(() => {
    ...
    // Redirect if not authenticated or if user is not a customer
    if (!isAuth) {
      navigate("/portal");
      return;
    }
    ...
    if (role !== "customer") {
      // Redirect providers to their portal or login page
      if (role === "provider") {
